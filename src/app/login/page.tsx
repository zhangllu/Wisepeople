        ...
        <CardContent className="pt-4">
          ...
          <div className="space-y-2 mb-4">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 rounded-lg border bg-background px-4 py-2 text-sm font-medium hover:bg-muted/50 transition-colors"
            >
