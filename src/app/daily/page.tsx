    ...
    <div className="min-h-screen bg-amber-50/40">
      ...
      <div className="mx-auto px-8 py-12" style={{ maxWidth: "820px" }}>
        ...
        <header className="mb-10">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">
            每日智者{String(today.day).padStart(3, "0")}
          </h1>
      ...
      {showCalendar ? (
        <aside className="hidden lg:block fixed right-6 top-20 z-10">
          <div className="relative">
            <button
              ...
              className="absolute -top-2 -right-2 w-5 h-5 bg-white rounded-full border border-gray-200 flex items-center justify-center text-[10px] text-gray-400 hover:text-gray-600 shadow-sm z-10"
            >
              ✕
            </button>
            <Calendar dayIndex={dayIndex} onSelect={setDayIndex} />
        ...
        <button
          ...
          className="hidden lg:flex fixed right-6 top-20 items-center gap-1 text-xs text-gray-400 bg-white border border-gray-200 rounded-lg px-2.5 py-1.5 hover:text-gray-600 hover:border-gray-300 shadow-sm transition-colors"
        >
          日历
        </button>
      )}
