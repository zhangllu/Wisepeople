...
interface KnowledgeMapProps {
  ...
  onQuestionSelect: (qNum: number | null) => void
}
...
export function KnowledgeMap({
  ...
  const handleZoneClick = (qNum: number) => {
    onQuestionSelect(selectedQuestion === qNum ? null : qNum)
  }
  ...
  return (
    <div className="relative w-full">
      ...
      >
        ...
        {/* 行人 Q08 */}
        {(() => {
          const x = 160; const y = 242; const q = 8; const active = selectedQuestion === q
          return (
        ...
        {/* 行人 Q09 */}
        {(() => {
          const x = 450; const y = 248; const q = 9; const active = selectedQuestion === q
          return (
            <g transform={`translate(${x},${y})`} className="cursor-pointer" onClick={() => handleZoneClick(q)}>
              {active && <circle cx="0" cy="0" r="28" fill="rgba(192,112,80,0.12)" stroke="#c07050" strokeWidth="1.5" strokeDasharray="4,3" />}
              <ellipse cx="0" cy="-18" rx="8" ry="9" fill="#3a2010" />
        ...
        {/* 行人 Q10 */}
        {(() => {
          const x = 740; const y = 244; const q = 10; const active = selectedQuestion === q
          return (
            <g transform={`translate(${x},${y})`} className="cursor-pointer" onClick={() => handleZoneClick(q)}>
              {active && <circle cx="0" cy="0" r="28" fill="rgba(192,112,80,0.12)" stroke="#c07050" strokeWidth="1.5" strokeDasharray="4,3" />}
              <ellipse cx="0" cy="-18" rx="8" ry="9" fill="#3a2010" />
        ...
        {selectedQuestion === 1 && <ellipse cx="450" cy="289" rx="48" ry="20" fill="none" stroke="#c8a010" strokeWidth="2" strokeDasharray="4,3" />}
